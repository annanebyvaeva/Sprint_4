...
import ru.yandex.praktikum.pom.main.QuestionBlock;
...
public QuestionsTest(String indexQuestion, String indexAnswer, String expect) {
    ...
    public void checkQuestions() {
        ...
        questionBlock.scrollQuestion();
        String questions = String.format("//div[@id='accordion__heading-%s']", indexQuestion);
        By quest = By.xpath(questions);
        new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(quest)).click();
        String answers = String.format("//div[@id='accordion__panel-%s']/p", indexAnswer);
        By ans = By.xpath(answers);
        String actual = driver.findElement(ans).getText();
